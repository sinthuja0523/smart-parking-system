...
<body>
  ...
  <section class="find_section">
    <div class="container">
        <form action="{{ url('searchslots') }}" method="get">

        <div class=" form-row">
          <div class="col-lg-3">
            <label for="carlocation">Select Location</label>
            <select name="location" class="form-control" id="carlocation"  required >
          ...
          <div class="col-lg-3">
            ...
            <input type="date" name= "date" class="form-control"id="parkingDate" placeholder=" " required >
          </div>

          <div class="col-lg-3">
            <label for="parkingTime">Select Your Time</label>
            <input type="time"name="time" class="form-control" id="parkingTime" placeholder=" " required>
          </div>
          <div class="col-lg-3">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('')}}/assets/images/money.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Save Money
        ...
        <div class="col-md-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('')}}/assets/images/clock.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Save Time
        ...
        <div class="col-md-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('')}}/assets/images/man.png" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Save Stress
        ...
        <div class="col-md-6">
          <div class="img-container">
            <div class="row">
              <div class="col-sm-6">
                <div class="img-box">
                  <img src="{{url('')}}/assets/images/w-1.jpg" alt="">
                  <a href="">
              ...
              <div class="col-sm-6">
                <div class="img-box">
                  <img src="{{url('')}}/assets/images/w-2.jpg" alt="">
                  <a href="">
                    <img src="{{url('')}}/assets/images/link.png" alt="">
                  </a>
                </div>
              ...
              <div class="col-sm-6">
                <div class="img-box">
                  <img src="{{url('')}}/assets/images/w-3.jpg" alt="">
                  <a href="">
                    <img src="{{url('')}}/assets/images/link.png" alt="">
                  </a>
                </div>
              ...
              <div class="col-sm-6">
                <div class="img-box">
                  <img src="{{url('')}}/assets/images/w-4.jpg" alt="">
                  <a href="">
                    <img src="{{url('')}}/assets/images/link.png" alt="">
                  </a>
                </div>
  ...
  <section class="service_section layout_padding-bottom" id = "service">
    <div class="container">
      <div class="heading_container">
        <h2>
          Our Services
      ...
      <div class="row">
        ...
        <div class="col-lg-2">
          ...
          <div class="info_social">
            ...
            <div>
              <a href="">
                <img src="{{url('')}}/assets/images/insta.png" alt="">
              </a>
            </div>
          </div>
        </div>
